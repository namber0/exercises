class Purchase:
    ...
    def get_price(self, buy_number):
        if buy_number >= 10:
            print("You will pay {} VND.".format(self.price * buy_number * 0.9))
        elif buy_number >= 5:
            print("You will pay {} VND".format(self.price * buy_number * 0.95))
        else:
            print("You will pay {} VND".format(self.price * buy_number))
